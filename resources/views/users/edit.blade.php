            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show userName">
                        <h1 class="samuramart-edit-user-info-value">{{ $user->name }}</h1>
                    </div> 
                ...
                <div class="form-group">
                    <div class="d-flex justify-conetent-between">
                        <label for="email" class="text-md-left samuraimart-edit-user-info-label">メールアドレス</label>
                        <span onclick="switchEditUserInfo('.useMail', '.editUserMail', '.userMailEditLabel');" class="userMailEditLabel user-edit-label">
                            編集
                        </span>
                    </div>
                    ...
                    <div class="collapse editUserMail">
                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email" autofocus placeholder="samurai@samuri.com">
                ...
                <hr>
                 ...
                 <div class="form-group">
                    <div class="d-flex justify-conetent-between">
                        ...
                        <span onclick="switchEditUserInfo('.usePhone', '.editUserPhone', '.userMailEditLabel');" class="userPhoneEditLabel user-edit-label">
                            編集
                        </span>
                    </div>
                    ...
                    <div class="collapser editUserPhone"></div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="saticBackdropLabel"><label>本当に退会しますか？</label></h5>

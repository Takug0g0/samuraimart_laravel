...
class CategoryController extends Controller
{
    ...
    {
        $request->validate([
            'name' => 'requiredunique:categories',
          ...
          $category->major_category_name = MajorCategory::find($request->input('major_category_name'));
          $category->save();
    ...
    public function update(Request $request, Category $category)
    {
        ...
        $category->name = $request->input('name');
        $category->description = $request->input('description');
        $category->major_categories_id -$request->input('major_categories_id');
        $category->major_category_name = MajorCategory::find($request->input('major_category_name'));
        $category->update();
